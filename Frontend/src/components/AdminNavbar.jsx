...
const AdminNavbar = () => {
  ...
  const [menuAbierto, setMenuAbierto] = useState(false); // Estado para menú hamburguesa
  ...
  return (
    <>
      ...
      <section className={`panel-botones ${menuAbierto ? "abierto" : ""}`}>
        <div className="Cont-Nav">
          ...
          <div className="Cont-Nav-Opt">
            <button onClick={() => { navigate("/admin"); setMenuAbierto(false); }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M7.5 2.5H3.33333C2.8731 2.5 2.5 2.8731 2.5 3.33333V9.16667C2.5 9.6269 2.8731 10 3.33333 10H7.5C7.96024 10 8.33333 9.6269 8.33333 9.16667V3.33333C8.33333 2.8731 7.96024 2.5 7.5 2.5Z" stroke="white" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M16.666 2.5H12.4993C12.0391 2.5 11.666 2.8731 11.666 3.33333V5.83333C11.666 6.29357 12.0391 6.66667 12.4993 6.66667H16.666C17.1263 6.66667 17.4993 6.29357 17.4993 5.83333V3.33333C17.4993 2.8731 17.1263 2.5 16.666 2.5Z" stroke="white" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round" />
          ...
          <div className="Cont-Logout">
            <button className="btn-cerrar-sesionAdmin" onClick={() => { handleLogout(); setMenuAbierto(false); setTimeout() }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path d="M10.6665 11.3332L13.9998 7.99984L10.6665 4.6665" stroke="#D4183D" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M14 8H6" stroke="#D4183D" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M6 14H3.33333C2.97971 14 2.64057 13.8595 2.39052 13.6095C2.14048 13.3594 2 13.0203 2 12.6667V3.33333C2 2.97971 2.14048 2.64057 2.39052 2.39052C2.64057 2.14048 2.97971 2 3.33333 2H6" stroke="#D4183D" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              Cerrar sesión
            </button>
            <button className="volver-admin" onClick={() => { navigate("/"); setMenuAbierto(false); }}>Volver a bikestore</button>
          </div>
        </div>
